...
def train(version,
    ...
    trainloader, valloader,traindata,valdata = compile_data(version, dataroot, data_aug_conf=data_aug_conf,
    ...
    for epoch in range(nepochs):
        ...
        if epoch % 1 ==0:
            ...
            model.eval()
            mname = os.path.join(logdir, "{}model{}.pt".format(now,counter))
            print('saving', mname)
